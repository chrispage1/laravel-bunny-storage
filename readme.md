...
'bunny' => [
    ...
    'token_auth_key' => env('BUNNY_TOKEN_AUTH_KEY', ''), // optional if you'd like signed URLs
...
#BUNNY_TOKEN_AUTH_KEY="your-token-auth-key" (optional, under CDN > Security > Token Authentication)
```
